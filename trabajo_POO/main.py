...
def main_producto():
    ...
    while True:
        ...
        if opcion == "2":
            ...
            if productos:
                ...
                for producto in productos:
                    ...
                    print(f"PRECIO:{int(producto.precio)} ")
        ...
        if opcion == "3":
            ...
            producto = Producto (id=int(id), nombre= nombre, descripcion = descripcion, precio=int(precio), id_tipo_producto=id_tipo_producto) 
...
def main_repartidor():
    ...
    while True:
        ...
        if opcion == "1":
            ...
            apellidos = input("apellidos del repartidor: ")
